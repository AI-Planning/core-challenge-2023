...
weights of 5, 3, 2 and 1 (which is equivalent to running $\textup{A}^*$). This anytime configuration will continually find shorter and shorter plans as long as the time allows.
